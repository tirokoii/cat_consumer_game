...
New bug, when player goes into corner, if the player isn't fully in the corner it first sends it to the other side and then it makes the player move so that it extends in both x and y, which then makes the player reach the other end of the screen bounds.